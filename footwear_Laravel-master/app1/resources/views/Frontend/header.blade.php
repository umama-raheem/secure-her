  ...
  <div class="container">
    ...
    <div id="nav" class="collapse navbar-collapse">
      <ul class="navbar-nav ms-auto align-items-lg-center">
        ...
        <li class="nav-item"><a class="nav-link" href="{{ url('/contact') }}">Contact & Map</a>
        </li>
       <li class="nav-item ms-lg-3">
          <a id="sosButton" class="btn btn-sos" href="javascript:void(0)" aria-label="Emergency SOS Button">
            <i class="fa-solid fa-bell me-1"></i> Emergency SOS
          </a>
        </li>
